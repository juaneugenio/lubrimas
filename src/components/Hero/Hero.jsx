...
const Hero = () => {
  ...
  return (
    <div className="bg-gradient-to-bl from-emerald-800 to-emerald-200 px-4 py-10 md:px-6 md:h-[50vh] lg:h-[75vh]">
      <div className="relative w-full max-w-[1200px] mx-auto flex flex-col md:flex-row items-center h-full border-2">
        ...
        <motion.div
          ...
          className="mb-5 md:w-[450px] md:absolute md:left-0 md:top-13 z-20 border-2"
        >
          <motion.h1 
            className="text-5xl md:text-6xl md:pt-0 font-bold mb-6"
        ...
        <motion.div
          ...
          className="flex justify-center items-center md:max-w-[500px] md:absolute md:right-0 md:bottom-25 lg:max-w-3/4 lg:bottom-25 lg:right-5 border-2 border-amber-300"
        >
          <img 
